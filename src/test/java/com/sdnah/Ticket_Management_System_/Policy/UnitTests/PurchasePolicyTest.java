...
class PurchasePolicyTest {
    ...
    void GivenDefaultPurchasePolicy_WhenQuantityOne_ThenReturnTrue() {
        PurchasePolicy policy = new PurchasePolicy("Default", EVENT_ID, COMPANY_ID);
    ...
    void GivenMaxTicketsTwo_WhenQuantityThree_ThenReturnFalse() {
        PurchasePolicy policy = new PurchasePolicy("Max two", EVENT_ID, COMPANY_ID);
    ...
    void GivenMinTicketsTwo_WhenQuantityOne_ThenReturnFalse() {
        PurchasePolicy policy = new PurchasePolicy("Min two", EVENT_ID, COMPANY_ID);
    ...
    void GivenMinAge18_WhenBuyerAge16_ThenReturnFalse() {
        PurchasePolicy policy = new PurchasePolicy("18+ policy", EVENT_ID, COMPANY_ID);
    ...
    void GivenAndRule_WhenAllConditionsMet_ThenReturnTrue() {
        PurchasePolicy policy = new PurchasePolicy("Age 18+ AND max 5", EVENT_ID, COMPANY_ID);
    ...
    void GivenOrRule_WhenOneConditionMet_ThenReturnTrue() {
        PurchasePolicy policy = new PurchasePolicy("Max 2 OR Min 100", EVENT_ID, COMPANY_ID);
    ...
    void GivenPolicyWithRules_WhenClearRules_ThenAllPurchasesAllowed() {
        PurchasePolicy policy = new PurchasePolicy("With rules", EVENT_ID, COMPANY_ID);
        policy.addRule(new MinAgeRule(18));
