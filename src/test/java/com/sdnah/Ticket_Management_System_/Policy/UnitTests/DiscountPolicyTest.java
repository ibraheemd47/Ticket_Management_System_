...
class DiscountPolicyTest {
    ...
    void GivenNoDiscountRules_WhenCalculateFinalPrice_ThenReturnOriginalPrice() {
        DiscountPolicy policy = new DiscountPolicy("No discount", EVENT_ID, COMPANY_ID);
    ...
    void GivenPercentageDiscount_WhenCalculateFinalPrice_ThenReturnReducedPrice() {
        DiscountPolicy policy = new DiscountPolicy("Percentage discount", EVENT_ID, COMPANY_ID);
    ...
    void GivenTwoDiscountRules_WhenNotAdditive_ThenBestDiscountChosen() {
        DiscountPolicy policy = new DiscountPolicy("Best discount", EVENT_ID, COMPANY_ID);
    ...
    void GivenTwoDiscountRules_WhenAdditive_ThenApplyCumulative() {
        DiscountPolicy policy = new DiscountPolicy("Additive discount", EVENT_ID, COMPANY_ID);
        policy.setRules(
                java.util.List.of(
    ...
    void GivenConditionalDiscountAndQuantityEnough_WhenCalculateFinalPrice_ThenDiscountApplied() {
        DiscountPolicy policy = new DiscountPolicy("Conditional discount", EVENT_ID, COMPANY_ID);
    ...
    void GivenCouponDiscountAndCorrectCoupon_WhenCalculateFinalPrice_ThenDiscountApplied() {
        DiscountPolicy policy = new DiscountPolicy("Coupon discount", EVENT_ID, COMPANY_ID);
    ...
    void GivenCouponDiscountGreaterThan100Percent_WhenCalculateFinalPrice_ThenReturnZero() {
        DiscountPolicy policy = new DiscountPolicy("Free coupon", EVENT_ID, COMPANY_ID);
    ...
    void GivenNullDiscountRule_WhenAddRule_ThenExceptionThrown() {
        DiscountPolicy policy = new DiscountPolicy("Null rule", EVENT_ID, COMPANY_ID);
    ...
    void GivenValidDiscountRule_WhenAddRule_ThenDiscountApplied() {
        DiscountPolicy policy = new DiscountPolicy("Has discount", EVENT_ID, COMPANY_ID);
        policy.addRule(new PercentageDiscountRule(10.0, "10% off"));
    ...
    void GivenDiscountRule_WhenClearRules_ThenNoDiscountApplied() {
        DiscountPolicy policy = new DiscountPolicy("Clear test", EVENT_ID, COMPANY_ID);
    ...
    void GivenConditionalDiscount_WhenQuantityEnough_ThenDiscountPositive() {
        DiscountPolicy policy = new DiscountPolicy( "Conditional", EVENT_ID, COMPANY_ID);
    ...
    void GivenOnlyPercentageDiscount_WhenComputeDiscount_ThenAlwaysPositive() {
        DiscountPolicy policy = new DiscountPolicy( "Percentage", EVENT_ID, COMPANY_ID);
        policy.addRule(new PercentageDiscountRule(10.0, "10% off"));
